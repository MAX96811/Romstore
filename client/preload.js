...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    restoreSwitchBundle: (payload) => ipcRenderer.invoke('restore-switch-bundle', payload),
    backupSwitchBundle: (payload) => ipcRenderer.invoke('backup-switch-bundle', payload),
